...
namespace xBindingDataExample.Models
{
    ...
    public class BookMaganer
    {
        public static List<Book> GetBooks()
        {
            ...
            books.Add(new Book { BookId = 9, Title = "Suscipit Ad", Author = "Jack Tibble", CoverImage = "Assets/9.png" });
            books.Add(new Book { BookId = 10, Title = "Decima", Author = "Tuffy Tibble", CoverImage = "Assets/10.png" });
